...
<html>
  ...
  <div class="container-fluid">
	...
	<div class="main">
  <div class="login-box">
    <div class="info">Email já cadastrado</div>
	<br/>
    ...
    <script type="text/javascript">
		...
		//caso ocorra um erro ele preenchera inputs com o que o usuario digitou, e ele reencaminha o form para voltar na tela de cadastro
	</script>
